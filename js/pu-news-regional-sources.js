(function (global) {
  ...
  var 목록 = [
    ...
    /* ★★ 2026-09-13 대표 지시 「꼭지를 넓히는 일(노무 → 노무+기업지원) 이것도 같이해라」로
         «서버가 읽는 자리»가 되었다. 노무가 아니라 «기업지원»으로 가린다(기업지원말).
       ⚠ 이 판에는 제목 링크가 없다 — <button onclick="fn_search_detail('아이디')"> 다.
         href 만 찾던 읽개로는 0건이었다. */
    { id:'cheonan-company', 기관:'천안시', 이름:'기업지원 공고', 지역:'충남/천안시', 방식:'board',
      ...
      공공누리:'게시물별 유형 확인',
      살핌:'2026-09-13 실측 — 200(옛 주소는 404였다). 기업지원 8건이 들어온다: 육성자금·물류비·해외시장개척단·전시회 탐방단·홍보판매관' }
  ];

...
test('★ 미리보기는 «원문 링크 그대로» — 추적을 걸지 않는다', () => {
  ...
  /* ⚠ 2026-09-08 부터 기사는 «우리 말»이 있어야 편지에 나간다 — 없으면 편지가
     ...
     ⚠⚠ 이 자리의 기사 링크 규칙이 «두 번» 뒤집혔다:
       2026-09-18 「원문 클릭 매일노동뉴스로 가지말고」 → 기사 원문 링크를 아예 뺐다.
         (그때는 자료 링크(moel.go.kr)로만 «감싸지는지»를 봤다.)
       2026-09-20 「주간노동뉴스는 왜 팝업도 없고 기사도 없나」 → 기사에도 다시
         원문 링크가 붙는다. 그래서 이제는 기사 링크로도 «감싸이지 않는지»를 본다 —
         자료 링크 하나만 보던 그물보다 넓어졌다.
     ⚠⚠ 자료(policy) 쪽 fixture 도 «파일»을 준다 — 같은 날 「팝업창으로 바로
       가지마라」로 제목의 x.링크 표시 링크(상세 페이지)는 걷었다. 지금 자료가
       내주는 유일한 클릭은 «내려받기»(x.파일)뿐이라, 그것으로 감싸임을 잰다. */
  ...
  assert.ok(/moel\.go\.kr\/file\.do\?id=1/.test(미리.서식),
    '★ 미리보기에도 추적 링크가 들어간다 — 눌러도 빈 포털로 튕기고, 셈이 부풀려진다');
  /* ★★★ 기사 원문 링크는 «그대로 나가되»(2026-09-20), 진짜 주소 그대로다 — 감싸이면 안 된다 */
  assert.ok(/labortoday\.co\.kr/.test(미리.서식),
    '★★★ 기사 원문 링크가 미리보기에서 사라졌다');
  ...
  /* ★★★ 진짜 편지에서는 기사 원문 링크도 «감싸여야» 한다 — 안 감싸이면 그 클릭이 안 잡힌다 */
  assert.ok(!/href="https:\/\/www\.labortoday\.co\.kr/.test(진짜.서식),
    '★★★ 기사 원문 링크가 감싸이지 않은 맨 주소로 나간다 — 클릭이 안 잡힌다');
});

...
// ⚠ 2026-09-19 다시 겨눔 — 계약창이 라벨-없는-6칸으로 바뀌며 단추 글자가 더 짧아졌다
//   (「📇 기업정보함 정보 가져오기」 → 「📇 가져오기」+ 옆의 짧은 「보기」 링크로 갈라짐).
//   지켜야 할 규칙은 문구가 아니라 «회사정보만 가져오고 사진은 안 가져온다는 안내»다.
t('단추 글자가 「가져오기」', /'📇 가져오기'/.test(src), true);
t('사진은 기업정보함에서 보라고 길을 준다', /사진은 기업정보함에서 보세요/.test(src), true);

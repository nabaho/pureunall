...
/* ⚠ 2026-09-20(4걸음) — 「⑬ ★ 재무 대시보드 「계약 기준 참고치」도 뺀다」 검사를 뺐다.
   그 참고치(contractFix)는 법인 대시보드 「분석」 탭에만 있었고, 그 화면을 걷어냈다
   (대표 결정 2026-09-20 — 옮긴 것이 아니라 없앴다).
   ★ 중단 업체를 뺀다는 규칙 자체는 살아 있다 — 위 열두 가지가 그대로 지킨다.
   ⚠ 참고치를 어딘가에 다시 만들면 이 검사도 함께 되살릴 것 —
     안 걸면 업체관리 화면과 «다른 금액»이 뜨고, 어느 쪽이 맞는지 아무도 모른다. */

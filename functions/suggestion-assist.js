...
const MASKS = [
  /* 사람 — 호칭이 붙은 한글 이름. 「홍길동 님」 「임꺽정 과장」
     ⚠ 예시에 «진짜 이름»을 적지 말 것. 2026-09-11 에 여기 실제 의뢰인 이름을
       적었다가 공개 저장소에 그대로 올라갔다(PR #1187). 가림망을 만들면서
       가려야 할 것을 코드에 적은 것이다 — 예시는 늘 홍길동·임꺽정으로. */
